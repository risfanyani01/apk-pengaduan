    ...
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title">
            ...
            </span> Data Pengaduan Yang Sedang Diproses
          </h3>
      </div>
            <div class="container">
                <div class="row">
                                       ...
                                       @forelse ($data as $item)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('pengaduan.detail',$item->id)}}" class="btn btn-sm btn-info"><i class="mdi mdi-eye"></i></a>
                                                    {{-- <a href="{{route('pengaduan.done',$item->id)}}" class="btn btn-sm btn-success"><i class="mdi mdi-check"></i></a> --}}
                                                </td>
                                                </tr>
                                       @empty
                                           <tr>
